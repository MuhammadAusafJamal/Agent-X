...
| --- | --- | --- | --- |
| [0 — Foundation](phases/phase-0-foundation.md) | Both apps boot against a real schema and share one typed contract | `npm run dev` serves a dashboard wired to a live API and database | `TODO` |
| [1 — Catalog](phases/phase-1-catalog.md) | Somewhere to hang tests | Create project → application → environment | `TODO` |
| [2 — Recorder](phases/phase-2-recorder.md) | The headline input path | Record a login by hand; watch it become an editable English spec | `TODO` |
