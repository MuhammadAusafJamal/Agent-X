...
| [6 — Heal](phases/phase-6-heal.md) | Close the loop | Move a field → self-heal. Break logic → file a bug instead | **`DONE`** (prompts unverified against a live model — see phase file) |
